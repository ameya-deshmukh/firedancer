...
fd_aio_new( void *        mem,
            void *        ctx,
            fd_aio_recv_t recv ) {
  if( FD_UNLIKELY( !mem || !recv ) ) return NULL;
...
static inline fd_aio_t * fd_aio_join  ( void     * _aio ) { return (fd_aio_t *)_aio; }
static inline void     * fd_aio_leave ( fd_aio_t * _aio ) { return (void     *)_aio; }
static inline void     * fd_aio_delete( void     * _aio ) { return (void     *)_aio; }
